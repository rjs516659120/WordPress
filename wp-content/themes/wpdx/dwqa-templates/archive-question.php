...
<div class="dwqa-questions-archive">
	<?php if ( dwqa_current_user_can( 'post_question' ) ) : ?>
		<div class="dwqa-ask-question my-dwqa-ask-question"><a href="<?php echo dwqa_get_ask_link(); ?>"><?php _e( 'Ask Question', 'wpdx' ); ?></a></div>
	<?php endif; ?>
	...
	<div class="dwqa-questions-list">
		...
		<?php if ( dwqa_has_question() ) : ?>
			<?php //ob_start(); 
			while ( dwqa_has_question() ) : dwqa_the_question(); ?>
...
<div class="dwqa-questions-footer">
	...
	<?php if ( dwqa_current_user_can( 'post_question' ) ) : ?>
		<div class="dwqa-ask-question"><a href="<?php echo dwqa_get_ask_link(); ?>"><?php _e( 'Ask Question', 'wpdx' ); ?></a></div>
	<?php endif; ?>
</div>
