...
class Nav_Menu_Roles {
    ...
    */
    public function __clone() {
        _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?' , 'wpdx'), '1.5' );
    }
    ...
    */
    function admin_init() {
      /* include the custom admin walker */
      include_once( TEMPLATEPATH . '/functions/class.Walker_Nav_Menu_Edit_Roles.php');
    ...
    */
    function register_importer(){
      ...
      include_once( TEMPLATEPATH . '/functions/class.Nav_Menu_Roles_Import.php');
    ...
    */
    ...
    /*function load_text_domain() {
        load_plugin_textdomain( 'wpdx', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
    }*/
    ...
    /*function admin_notice() {
        ...
        if ( ! empty ( $conflicts ) ) {
            ...
            if ( ! get_user_meta( $user_id, 'nmr_ignore_notice' ) ) {
                ...
                <p>';
                printf ( __( 'Nav Menu Roles has detected a possible conflict with the following functions or classes: %1$s. Please see the %2$sFAQ%3$s for more information and possible resolution. | %4$sHide Notice%3$s', 'wpdx' ),
    ...
    function custom_fields( $item_id, $item, $depth, $args ) {
        ...
        */
        ...
        <div class="field-nav_menu_role nav_menu_logged_in_out_field description-wide" style="margin: 5px 0;">
            <span class="description"><?php _e( "Display Mode", 'wpdx' ); ?></span>
            <br />
        ...
        <div class="field-nav_menu_role nav_menu_role_field description-wide" style="margin: 5px 0;">
            <span class="description"><?php _e( "Limit logged in users to specific roles", 'wpdx' ); ?></span>
            <br />
    ...
    */
    function enqueue_scripts( $hook ){
        if ( $hook == 'nav-menus.php' ){
            wp_enqueue_script( 'cmp-nav-menus', get_template_directory_uri() . '/assets/js/nav-menu-roles.js' , array( 'jquery' ), '1.5', true );
        }
    }
