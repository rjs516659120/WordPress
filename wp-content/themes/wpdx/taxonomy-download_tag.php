    ...
    <section class="span8 archive-list">
      ...
      <div class="widget-box" role="main">
        <header id="archive-head">
          <h1>
            <?php echo __('Tag: ','wpdx') . single_term_title( '', false ) ; ?>
            <?php if( cmp_get_option( 'category_rss' ) ): ?>
              <a class="rss-cat-icon" title="<?php _e( 'Subscribe to this tag', 'wpdx' ); ?>" href="<?php echo get_term_feed_link($term_id,'download_tag') ?>"><i class="fa fa-rss fa-fw"></i></a>
            <?php endif; ?>
          </h1>
          <?php
